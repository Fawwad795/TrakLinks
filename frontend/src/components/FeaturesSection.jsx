  ...
  return (
    <div className="w-full relative py-7.5">
      <div className="w-full max-w-7xl mx-auto px-4 grid grid-cols-12 relative">
        ...
        <div className="w-full h-auto col-span-10 col-start-2 bg-gradient-to-br from-[#726bae] to-[#1E184A] rounded-lg grid grid-cols-1 md:grid-cols-10">
          ...
          <div className="col-span-full md:col-start-6 md:col-span-5 top-[0px] h-auto z-10 pt-[15px] px-6 grid place-content-end">
            <p className="max-w-md mx-auto md:mx-0 text-center md:text-left text-white text-base md:text-[11px] lg:text-lg lg:pb-2">
              TrakLinks gives you full control over every click with powerful
              tools for creators, marketers, and businesses—offering real-time
              analytics, customizable URLs, and dynamic QR codes for smarter
              link management.
            </p>
          </div>
          ...
          <div
            className="col-span-full mt-5 mb-8 px-4 md:px-10 relative"
          ...
          >
            ...
            <div className="relative sm:h-[420px] md:h-[250px] lg:h-[320px] overflow-hidden rounded-xl perspective">
              ...
              <button
                onClick={handlePrev}
                className="absolute sm:top-45/100 left-4 md:top-1/2 -translate-y-1/2 z-20 bg-white/90 hover:bg-white text-[#27215B] rounded-full w-10 h-10 flex items-center justify-center shadow-lg backdrop-blur-sm transition-all duration-300 hover:scale-110"
              ...
              <button
                onClick={handleNext}
                className="absolute right-4 sm:top-45/100 md:top-1/2 -translate-y-1/2 z-20 bg-white/90 hover:bg-white text-[#27215B] rounded-full w-10 h-10 flex items-center justify-center shadow-lg backdrop-blur-sm transition-all duration-300 hover:scale-110"
