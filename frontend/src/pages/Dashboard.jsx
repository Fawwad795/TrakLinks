...
import { allLinks, clicksTimeData, summaryStats, deviceData, osData, browserData, countryData } from '../constants/dummyAnalytics';
...
const Dashboard = () => {
  ...
  return (
    <div className="grid grid-cols-12 min-h-screen">
      ...
      <div className={`${isCollapsed ? 'col-span-11' : 'col-span-9'} bg-gray-100 flex flex-col h-screen overflow-hidden`}>
        {/* Header */}
        <Header 
          title="Dashboard" 
        ...
        <div className="p-6 space-y-6 custom-scrollbar overflow-y-auto flex-grow">
          {/* Links List Section */}
          <div className="mb-6">
            <h2 className="text-lg font-semibold text-[#2B2376] mb-4">Your Links</h2>
            <DashboardLinkList 
              links={allLinks} 
          ...
          {selectedLink && (
            <div className="mb-6">
              <h2 className="text-lg font-semibold text-[#2B2376] mb-4">
                Analytics for: <span className="text-gray-700">{selectedLink.title}</span>
              </h2>
